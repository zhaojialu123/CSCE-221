...
public:
  DListNode<T>(T k=T(),T v=T(), DListNode<T> *p = nullptr, DListNode<T> *n = nullptr)
...
public:
  ...
  T firstKey() const; // return the first object's key
  T firstValue() const; // return the first object's value
  T lastKey() const; // return the last object's key
  T lastValue() const; // return the last object's value
  void insertFirst(T newKey, T newValue); // insert to the first of the list
  T removeFirst(); // remove the first node
  void insertLast(T newKey, T newValue); // insert to the last of the list
...
template<class T>void DoublyLinkedList<T>::insertFirst(T newKey, T newValue)
{ 
  DListNode<T> *newNode = new DListNode<T>(newKey, newValue, &header, header.next);
...
template<class T>void DoublyLinkedList<T>::insertLast(T newKey, T newValue)
{
  DListNode<T> *newNode = new DListNode<T>(newKey, newValue, trailer.prev,&trailer);
...
// return the first object's key
template<class T>T DoublyLinkedList<T>::firstKey() const
{ 
  if (isEmpty())
    throw EmptyDLinkedListException("Empty Doubly Linked List");
  // Complete this function
...
// return the first object's value
template<class T>T DoublyLinkedList<T>::firstValue() const
{ 
  if (isEmpty())
    throw EmptyDLinkedListException("Empty Doubly Linked List");
  // Complete this function
...
// return the last object's key
template<class T>T DoublyLinkedList<T>::lastKey() const
{
  if (isEmpty())
    throw EmptyDLinkedListException("Empty Doubly Linked List");
...
template<class T>T DoublyLinkedList<T>::lastValue() const
{
  if (isEmpty())
    throw EmptyDLinkedListException("Empty Doubly Linked List");
